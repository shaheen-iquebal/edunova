  ...
  const features = [
    {
      ...
      description:
        "Record & auto-transcribe lectures, meetings, or brainstorming sessions.",
      demo: "Last recorded: 'Strategies for engaging students in online learning.'",
    },
    {
      id: "scribble",
      ...
      description:
        "Convert handwritten lesson plans or grading notes into text.",
      demo: "Recently converted: 'Class attendance list and notes from today's lecture.'",
    },
    {
      id: "visualize",
      ...
      description:
        "Generate diagrams for class presentations and teaching materials.",
      demo: "Generated: Organizational chart for World War II events.",
    },
    {
      id: "summarize",
      title: "AI Summarizer",
      ...
      description:
        "Summarize students' submitted essays or class notes for quick review.",
      demo: "Summarized feedback from 25 student assignments.",
    },
    {
      id: "flashcards",
      title: "Auto Flashcards",
      icon: <CreditCard className="w-6 h-6" />,
      description: "Generate flashcards to share with students for revision.",
      demo: "20 flashcards created for Math Chapter 4 for student quizzes.",
    },
    {
      id: "companion",
      ...
      description:
        "Interact with notes or explain complex concepts for students.",
      demo: "Q: 'How to explain relativity to 8th graders?'",
    },
    {
      id: "grammar",
      ...
      description:
        "Improve writing for assignment instructions or feedback for students.",
      demo: "Improved: 'Please submit your homework.' → 'Kindly ensure your homework is submitted on time.'",
    },
    {
      id: "mindmap",
      ...
      description:
        "Create mind maps for lesson planning or curriculum overviews.",
      demo: "Generated: Mind map for 'Quarterly Lesson Plan.'",
    },
    {
      id: "audio-to-text",
      ...
      description:
        "Convert recorded classes or meetings into text for easy reference.",
      demo: "Transcribed: 'Class discussion on economic theories.'",
    },
    {
      id: "citation",
      ...
      description:
        "Generate citations for lesson materials or research references.",
      demo: "Citation for 'To Kill a Mockingbird': APA - Lee, H. (1960). To Kill a Mockingbird.",
    },
    {
      id: "concept-finder",
      ...
      description:
        "Identify key ideas in students' submitted assignments or notes.",
      demo: "Highlighted concepts: 'Photosynthesis, Chloroplast, Light Reaction' in Biology notes.",
    },
    {
      id: "language-helper",
      ...
      description:
        "Translate instructions or learning materials for multilingual classrooms.",
      demo: "Translated: 'Assignment due on Friday.' → 'Entrega de tareas el viernes.' (Spanish)",
    },
  ];
