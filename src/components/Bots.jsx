...
import botsData from "./../data/bots.json"; // Importing the JSON directly
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
              ...
              <p className="sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0">
                Choose from a range of AI-powered bots tailored to your grade
                and subject. Whether it’s Physics, Math, History, or more, start
                your journey to smarter learning today.
              </p>
            </div>
          </div>
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 sgap-2">
            {bots.map((bot, index) => (
